...
pub fn client_send_openai_gpt_summarization_request(socket_path: &str, text: String, prompt: String) -> anyhow::Result<OpenAIGPTSummarizationResult> {
    println!("client_send_request initiating");
    client_send_request(socket_path,OpenAIGPTSummarizationRequest{text,prompt})
}
